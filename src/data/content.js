...
import iconSocial from '../assets/images/icon-social.svg?raw';
import iconQuestion from '../assets/images/icon-question.svg?raw';
import iconTravel from '../assets/images/icon-travel.svg?raw';
import iconHeart from '../assets/images/icon-heart.svg?raw';
import iconDoctor from '../assets/images/icon-doctor.svg?raw';
import iconPerson from '../assets/images/icon-person.svg?raw';
import iconHealth from '../assets/images/icon-health.svg?raw';
import iconPeople from '../assets/images/icon-people.svg?raw';
import iconConversation from '../assets/images/icon-conversation.svg?raw';
import iconMedicalReview from '../assets/images/icon-medical-review.svg?raw';
import iconMedicalShield from '../assets/images/icon-medical-shield.svg?raw';
import iconLoveSpeech from '../assets/images/icon-love-speech.svg?raw';
...
export const carePartnersContent = {
  en: {
    ...
    items: [
      { id: 1, title: "Care partners play a powerful role", text: "As a care partner, your support can make a world of difference...", icon: iconGroup },
      ...
      { id: 3, title: "You don't have to do it alone", text: "There are numerous resources and support groups available for care partners.", icon: iconSocial },
      ...
      { id: 5, title: "Every decision is personal", text: "Choosing to participate in a clinical trial is a highly personal decision made between the patient and their doctor.", icon: iconTravel },
      { id: 6, title: "You deserve care, too", text: "Remember to take time for your own physical and mental well-being.", icon: iconHeart }
    ]
  },
  es: {
    ...
    items: [
      { id: 1, title: "Los compañeros de cuidado juegan un papel poderoso", text: "Como compañero de cuidado, su apoyo puede hacer un mundo de diferencia...", icon: iconGroup },
      ...
      { id: 3, title: "No tienes que hacerlo solo", text: "Existen numerosos recursos y grupos de apoyo disponibles.", icon: iconSocial },
      ...
      { id: 5, title: "Cada decisión es personal", text: "Elegir participar en un ensayo clínico es una decisión muy personal.", icon: iconTravel },
      { id: 6, title: "Usted también merece cuidado", text: "Recuerde tomar tiempo para su propio bienestar físico y mental.", icon: iconHeart }
    ]
  }
};
...
export const faqsContent = {
  en: {
    ...
    items: [
      { id: 1, title: "What are clinical trials?", text: "Clinical trials are research studies performed in people that are aimed at evaluating a medical, surgical, or behavioral intervention.", icon: iconDoctor },
      { id: 2, title: "Who can participate in a clinical trial?", text: "Every clinical trial has strict rules about who can and cannot participate, known as eligibility criteria.", icon: iconPerson },
      { id: 3, title: "What is the importance of clinical trial participation?", text: "Participants help researchers find better ways to treat, prevent, and understand human diseases.", icon: iconHealth },
      { id: 4, title: "Why does representation in clinical trials matter?", text: "People of different ages, races, and ethnicities may react differently to the same medical treatments.", icon: iconPeople },
      { id: 5, title: "What do people need to do if they decide they want to participate in a clinical trial?", text: "The first step is speaking with your healthcare provider to find trials that might be a good match.", icon: iconConversation },
      { id: 6, title: "How can people make an informed decision about participation in a clinical trial?", text: "Through the informed consent process, researchers must explain all risks, benefits, and alternatives.", icon: iconMedicalReview },
      { id: 7, title: "How are clinical trial participants protected?", text: "Institutional Review Boards (IRBs) and strict ethical guidelines ensure participant safety and rights.", icon: iconMedicalShield },
      { id: 8, title: "What happens after the trial ends?", text: "Researchers analyze the data to determine the next steps for the intervention being studied.", icon: iconLoveSpeech }
    ]
  },
  es: {
    ...
    items: [
      { id: 1, title: "¿Qué son los ensayos clínicos?", text: "Los ensayos clínicos son estudios de investigación realizados en personas...", icon: iconDoctor },
      { id: 2, title: "¿Quién puede participar en un ensayo clínico?", text: "Cada ensayo clínico tiene reglas estrictas sobre quién puede participar...", icon: iconPerson },
      { id: 3, title: "¿Cuál es la importancia de la participación en ensayos clínicos?", text: "Los participantes ayudan a los investigadores a encontrar mejores formas de tratar enfermedades...", icon: iconHealth },
      { id: 4, title: "¿Por qué es importante la representación en los ensayos clínicos?", text: "Personas de diferentes edades, razas y etnias pueden reaccionar de manera diferente a los mismos tratamientos médicos...", icon: iconPeople },
      { id: 5, title: "¿Qué deben hacer las personas si deciden que quieren participar?", text: "El primer paso es hablar con su proveedor de atención médica...", icon: iconConversation },
      { id: 6, title: "¿Cómo pueden las personas tomar una decisión informada sobre la participación?", text: "A través del proceso de consentimiento informado...", icon: iconMedicalReview },
      { id: 7, title: "¿Cómo se protege a los participantes de los ensayos clínicos?", text: "Las Juntas de Revisión Institucional (IRB) y las estrictas pautas éticas garantizan la seguridad...", icon: iconMedicalShield },
      { id: 8, title: "¿Qué sucede después de que termina el ensayo?", text: "Los investigadores analizan los datos para determinar los próximos pasos...", icon: iconLoveSpeech }
    ]
  }
};
